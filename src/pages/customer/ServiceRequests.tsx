        ...
        <CardContent className="p-12 text-center">
          ...
          <div className="mb-8">
            <div className="relative inline-flex">
              <Briefcase className="w-20 h-20 text-primary mx-auto" />
          ...
          <p className="text-muted-foreground text-lg leading-relaxed mb-8">
            We're building an amazing platform where you can request and manage 
            property-related services like home loans, movers, legal services, and more.
          </p>
