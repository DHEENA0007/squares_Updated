...
const RoleBasedDashboard = () => {
    ...
    return (
        <div className="p-6 space-y-6">
            ...
            <div>
                <Link to="/rolebased">
                    <h1 className="text-3xl font-bold hover:underline cursor-pointer">Dashboard</h1>
                </Link>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                {(hasPermission(PERMISSIONS.VENDORS_APPROVE) || hasPermission(PERMISSIONS.PROPERTIES_APPROVE)) && (
                    <Link to={hasPermission(PERMISSIONS.PROPERTIES_APPROVE) ? "/rolebased/properties" : "/rolebased/vendors"}>
                        <Card className="hover:bg-accent/50 transition-colors cursor-pointer">
                            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
